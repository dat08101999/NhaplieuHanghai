...
namespace CRUDAjax.Models
{
    public class EmployeeDB
    {
        ...
        string cs = @"Data Source=DESKTOP-APQDN6C\SQLEXPRESS;Initial Catalog=QuanLyEmployee;Integrated Security=True";
        ...
        public int Add(Employee emp)
        {
            ...
            using(SqlConnection con=new SqlConnection(cs))
            {
                ...
                com.Parameters.AddWithValue("@State", emp.States);
        ...
        public int Update(Employee emp)
        {
            ...
            {
                con.Open();
                SqlCommand com = new SqlCommand("ThemSuaXoa", con);
                com.CommandType = CommandType.StoredProcedure;
                com.Parameters.AddWithValue("@Id", emp.EmployeeID);
                com.Parameters.AddWithValue("@Name", emp.Name);
                com.Parameters.AddWithValue("@Age", emp.Age);
